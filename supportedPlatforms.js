var jsonData = { "oses": [
                   ...
                   { "name": "Linux",
                     "entries": [
                       { "description": "<strong>OpenCOR 0.1.x and 0.2:</strong> supported on both the 32-bit and 64-bit versions of <a href=\"https://en.wikipedia.org/wiki/Ubuntu_version_history#Ubuntu_12.04_LTS_(Precise_Pangolin)\">Ubuntu 12.04 LTS (Precise Pangolin)</a> and later." },
                       ...
                       { "description": "<strong>Snapshots:</strong> supported on the 64-bit version of <a href=\"https://en.wikipedia.org/wiki/Ubuntu_version_history#Ubuntu_20.04_LTS_(Focal_Fossa)\">Ubuntu 20.04 LTS (Focal Fossa)</a> and later." }
                     ]
                   },
                   { "name": "macOS",
                     "entries": [
                       { "description": "<strong>OpenCOR 0.1.x:</strong> supported on <a href=\"https://en.wikipedia.org/wiki/OS_X_Mountain_Lion\">OS X 10.8 (Mountain Lion)</a> and later." },
